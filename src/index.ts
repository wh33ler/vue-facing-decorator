...
export { decorator as State } from './option/state'
export { decorator as Mutation } from './option/mutation'
export { decorator as Action } from './option/action'
export { decorator as Getter } from './option/getter'
